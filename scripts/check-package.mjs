...
try {
  ...
  exec(process.execPath, ['--test', 'test/cli-commands.test.js', 'test/global-judge.test.js', 'test/help.test.js', 'test/web-launch.test.js', 'test/review-group.test.js', 'test/reviewer-selection.test.js', 'test/agy.test.js', 'test/opencode.test.js', 'test/new-agents.test.js'], {
